<template>
    <div class="card mt-4 record-play">
        <div class="content-flex-bettween">
            <h6>متجر الاشكال</h6>
            <button class="add-button" @click="addShapStore =true"> + إضافه</button>
        ...
        <popupShapesStore v-show="addShapStore" @closepopup="addShapStore = false"/>
    </div>
</template>
<script setup>
import Table from '@/components/global/table.vue';
import popupShapesStore from '@/components/pages/shopping/popup-shapes-store.vue';
import DatePicker from "primevue/datepicker";
import { ref } from 'vue';
import { useRouter } from 'vue-router';
const date = ref(new Date());
let router = useRouter();
const addShapStore =ref(false)
let headers = ref([
    { name: "الصورة", key: "image" ,type:"image"},
    { name: "الفئة", key: "category" },
    { name: "الاسم", key: "name" },
    { name: "المرتبة", key: "Rank",type:"image" },
    { name: "النوع", key: "type",type:"image"  },
    { name: "المدده", key: "duration"  },
...
let items = ref([
    {
        ...
        type: new URL('@/assets/images/type.svg', import.meta.url).href,
        duration:"مدى الحياة",
        price:"220",
