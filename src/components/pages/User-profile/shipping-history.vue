<template>
    <div class="card mt-4 record-play">
        <h6>سجل الشحن </h6>
        ...
        <div class="card-fillter ">
            <div class="fillter-search_account">
                ...
                <select><option>الجميع</option></select>
                </div>
            </div>
            <div class="content-flex">
        ...
        <Table :headers="headers" :data="items"></Table>
    </div>
    <button class="reloading"> <img src="@/assets/images/reload.svg"> تحديث البيانات </button>
</template>
<script setup>
...
let headers = ref([
    ...
    { name: "النوع", key: "type",type:"icons" },
    { name: "المقدار", key: "amount" ,icon:'icons'},
    { name: "طريقة المكسب", key: "howwin" },
]);
let items = ref([
    {
        id: 1,
        date: "25/10/2024",
        type: new URL('@/assets/images/profile-card1.svg', import.meta.url).href,
        statusUser: true,
        amount: "80000",
        howwin: "مكسب من لعبة دومينو"

    },
    {
        id: 2,
        date: "25/10/2024",
        type: new URL('@/assets/images/profile-card2.svg', import.meta.url).href,
        statusUser: false,
        Pointsearned: " +5000",
        amount: "80000",
        howwin: "مكسب من لعبة دومينو"
    ...
    },
    {
        id: 2,
        date: "25/10/2024",
        type: new URL('@/assets/images/profile-card3.svg', import.meta.url).href,
        statusUser: false,
        Pointsearned: " +5000",
        amount: "250",
        howwin: "مكسب من لعبة دومينو"
